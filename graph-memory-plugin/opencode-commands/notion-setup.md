---
description: Set up Notion sync — create workspace, databases, and wiki pages
---
...
1. Call `graph_memory` with action `notion_setup` to start the setup process.
2. If you have an existing Notion page you want to use as the parent, pass `parentPageId` with the page ID.
3. If you want a custom workspace name, pass `workspaceName` (default is "My Mind").
4. The setup will:
