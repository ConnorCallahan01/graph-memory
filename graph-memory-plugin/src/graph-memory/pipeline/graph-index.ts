/**
 * Graph Index — efficient on-demand querying for the knowledge graph.
 *
 * Map-keyed structure for O(1) path lookups, category-based filtering,
 * project-based filtering, incremental add/remove, and lazy load with
...
function indexPath(): string {
  return CONFIG.paths.graphIndex;
}
